        ...
        <div class="collection-tabs_container">
          <div class="owl-theme">
            <div class="owl-stage-outer">
              <div class="owl-stage">
                <div class="owl-item" v-for="(item,i) of items" :key="i">
          ...
          <div class="productblock" v-for="(p,i) of products" :key="i">
            ...
            <div class="product-info" id="info-container">
              ...
              <div class="product-info-inner">
                ...
                <form action>
                  <input type="submit" class="btn-main" value="Add" />
    ...
    methods: {
      load() {
        funs.getEyePalettes(result=>{
          ...
          console.log(result.data.eyepalettes[6].pic)
          console.log(result.data.eyepalettes[7].pic)
